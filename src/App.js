      ...
      <div className='gen-main'>
        <div className='generator'>
          ...
          <div className='display-div'>
            <div className='display' style={{ boxShadow: `${shadowPropertise.x}px ${shadowPropertise.y}px ${shadowPropertise.blur}px ${shadowPropertise.spread}px ${colorPicker} ${shadowType === "offset" ? "" : shadowType}`, background: `${shadowPropertise.displayBox}` }} >
